//-----------------------------------------------------------------------------//
//                                                                             //
//              Copyright © 2018 wankeyun.cc. All rights reserved.             //
//                                                                             //
//-----------------------------------------------------------------------------//
...
一、口袋账户管理：导入、导出（备份）、删除
二、导入文件存放在根目录的“keystore”下
三、每次交易需要输入密码，不保存，不传输您的密码
四、代码开源：https://github.com/ImbaQ/MyLinkToken


++ 常见问题 ++

软件无法运行请安装 Microsoft .NET Framework 4.6
https://www.microsoft.com/zh-cn/download/details.aspx?id=49982


++ 软件主页 ++

http://www.wankeyun.cc
